      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-16 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            {/* UNBLOCKED BROWSER BUTTON */}
            <button
              id="unblocked-browser-btn"
              onClick={onOpenBrowserModal}
              title="Unblocked Web Browser - Browse the web, search engines, tools & bypass filters"
              className="px-2 sm:px-2.5 py-1.5 rounded-md bg-gradient-to-r from-emerald-500 via-teal-600 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 font-orbitron font-bold text-[11px] flex items-center gap-1 shadow-md shadow-emerald-500/20 border border-emerald-300/80 transition-all active:scale-95 group"
            >
              <Globe className="w-3.5 h-3.5 text-slate-950 group-hover:rotate-45 transition-transform" />
              <span className="tracking-wide">BROWSER</span>
            </button>
            ...
            <button
              ...
              className="px-2 sm:px-2.5 py-1.5 rounded-md bg-gradient-to-r from-cyan-500 via-indigo-600 to-pink-500 hover:from-cyan-400 hover:to-pink-400 text-slate-950 font-orbitron font-bold text-[11px] flex items-center gap-1 shadow-md shadow-cyan-500/20 border border-cyan-300/80 transition-all active:scale-95 group"
            >
              <Bot className="w-3.5 h-3.5 text-slate-950 group-hover:rotate-12 transition-transform" />
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar border-t border-[#131726]">
          {/* Quick Unblocked Browser launcher pill */}
          <button
            id="cat-btn-browser-shortcut"
            onClick={onOpenBrowserModal}
            className="whitespace-nowrap px-3 py-1.5 rounded-md text-xs font-mono-cyber font-bold uppercase tracking-wider bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-300 border border-emerald-400/60 hover:border-emerald-300 shadow-sm flex items-center gap-1.5 transition hover:scale-105"
          >
            <Globe className="w-3 h-3 text-emerald-400" />
            <span>🌐 Web Browser</span>
            <span className="px-1.5 py-0.2 rounded text-[9px] bg-emerald-400/20 text-emerald-300 font-bold border border-emerald-400/30">
              PORTAL
            </span>
          </button>
